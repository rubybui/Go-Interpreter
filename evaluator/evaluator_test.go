...
// testEval is a helper function that evaluates a Monkey program string.
// It:
// 1. Creates a new lexer with the input
// 2. Creates a new parser with the lexer
// 3. Parses the program
// 4. Evaluates the program
...
// testIntegerObject is a helper function that verifies if an object
// is an integer with the expected value.
...
// TestErrorHandling tests the evaluation of error conditions.
// It verifies that the evaluator correctly handles:
